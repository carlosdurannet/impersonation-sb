...
public class ImpersonationRegistryImpl extends ImpersonationRegistryBaseImpl {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never reference this class directly. All methods that expect a impersonation registry model instance should use the {@link net.carlosduran.liferay.impersonation.sb.model.ImpersonationRegistry} interface instead.
	 */
	public ImpersonationRegistryImpl() {
	}
